...
\begin{itemize}
    ...
    \item \textbf{Arithm\'etique enti\`ere} : Bien que le c\oe ur Cortex-M4F dispose d'une FPU simple pr\'ecision, l'inf\'erence neuronale en \textit{float} est d\'elib\'er\'ement \'evit\'ee. Le choix \textbf{Int16} maximise le nombre de n\oe uds explor\'es par seconde, garantit un comportement d\'eterministe et simplifie le dimensionnement num\'erique sur une cible embarqu\'ee.. Cette approche exploite la puissance native du jeu d'instructions 32 bits pour transformer l'inférence en une séquence d'opérations entières à haute vélocité.
\end{itemize}
